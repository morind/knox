...
public class LogsearchDispatch extends DefaultDispatch {

    private static Logger log = LoggerFactory.getLogger(LogsearchDispatch.class);
    ...
    protected void executeRequest(HttpUriRequest outboundRequest, HttpServletRequest inboundRequest, HttpServletResponse outboundResponse) throws IOException {
        outboundRequest = LogSearchRequestUtil.modifyOutboundRequest(outboundRequest, inboundRequest);
